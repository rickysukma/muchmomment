...
@section('title','Create Post Photo')

@section('content')

<div id="layoutSidenav_content"><div class="container-fluid">
  <h1 class="mt-4">{{ $method['action'] == 'update' ? 'Edit' : 'Create' }} Post Photo</h1>
  <div class="row ml-2">
    <div class="card col-sm-8 shadow p-3 mb-5 bg-white rounded">
      ...
      @include('layouts/errors')
        ...
        {{ csrf_field() }}
          ...
          <div class="form-group">
            <label for="exampleFormControlFile1">Upload Image Thumbnail</label>
          ...
          <div class="form-group">
            ...
            <img id='preview' src="{{ url('/'.$post->path) }}" class="img-fluid" alt="{{ $post->title }}">
          </div>
          @endif
